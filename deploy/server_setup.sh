...
cp $PROJECT_BASE_PATH/project_restful_api/deploy/supervisor_restful_api.conf /etc/supervisor/conf.d/restful_api_app.conf
supervisorctl reread
supervisorctl update
supervisorctl restart restful_api_app

# Setup nginx to make our application accessible.
cp $PROJECT_BASE_PATH/project_restful_api/deploy/nginx_restful_api.conf /etc/nginx/sites-available/restful_api_app.conf
